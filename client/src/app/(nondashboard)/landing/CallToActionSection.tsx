...
const CallToActionSection = () => {
  return (
    <div className='relative py-24'>
        ...
        <div className='absolute inset-0 bg-black' style={{opacity:"60%"}}>
            ...
            >
                ...
                <div className=''>
                    ...
                    <div className='flex justify-center md:justify-start gap-4'>
                       ...
                       <Link href="/signup"
                       className='inline-block text-white bg-secondary-500 rounded-lg py-3 px-6 font-semibold hover:bg-secondary-600'
                       scroll={false}>
                       Sign Up
                       </Link>
