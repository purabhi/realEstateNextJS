...
<p className='mt-4 text-gray-600 text-lg '>Find Your Dream Rental Property Today !</p>
             ...
             {[
                {
                    ...
                    description : "Browse through our extensive collection of rentalproperties in your desired loc ation"
                },
                {
                    imageSrc:"/landing-icon-calendar.png",
                    title :"Boom Your Rental ",
